 ...
 */
const self_announcedIp = "35.209.224.228";
const self_localIp="10.128.0.15";
const os = require('os');

module.exports =
{
        // Listening hostname (just for `gulp live` task).
        domain :'sfu.brollyhub.com',
        ...
        https  :
        {
                ...
                tls        :
                {
                        cert : '/etc/letsencrypt/live/sfu.brollyhub.com/fullchain.pem',
                        key  : '/etc/letsencrypt/live/sfu.brollyhub.com/privkey.pem'
                }
        },
        // mediasoup settings.
        mediasoup :
                ...
                routerOptions :
                {
						...
						webRtcServerOptions :
						{
								...
								[
										{
												protocol         : 'udp',
												ip               : self_localIp || '0.0.0.0',
												announcedAddress : self_announcedIp,
												port             : 44444
										},
										{
												protocol         : 'tcp',
